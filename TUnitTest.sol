...
contract UnitTest {
    ...
    function UnitTest() payable{
        ...
        // Send 1 ether to the crowdsale contract Address
         //Token token = crowdSale.getToken();
         //token.transfer(0x449a46d0aE23612f059FA848702C2DF830F5ED4E, 1);

        //Log(crowdsale.getCurrentState());
        
        token = new Token("GIG9", "GIG", 8, 0xC7B38600299ab2657c6F341310DAdD9E1ba7398a, 268000000);
        token.transfer(0x449a46d0aE23612f059FA848702C2DF830F5ED4E,1);
    }
